...
You have been tasked with creating a service integration to a public API and exposing a RESTful endpoint. 
...
- Your REST endpoint `/api/rates` **must** return JSON object of the latest currency rates in the following format/schema:
